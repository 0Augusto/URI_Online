...
int main()
{
    ...
    else if (sal >= 1200.01 && sal <= 2000.00)
    {
        ...
        cout << "Reajuste ganho: " << fixed << setprecision(2) << reajuste << endl;
        double percent = (1.07 - 1.00) * 100;
        cout << "Em percentual: " << percent << " %" << endl;
    }
    else if(sal >= 2000.00)
    {
        double sal4 = (sal * 1.04);
        cout << "Novo salario: " << setprecision(2) << sal4 << endl;
        double reajuste = (sal4 - sal);
        cout << "Reajuste ganho: " << setprecision(2) << reajuste << endl;
        double percent = (1.04 - 1.00) * 100;
        cout << "Em percentual: " << percent << " %" << endl;
    }
    else
    {
